...
<div class="text-center">
    ...
    <br>
    <h3 class="text-2xl text-blue-900 mb-10"><a href="/page.php">Simple page: <?php echo e($name); ?></a></h3>
    <a class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" href="/page.php">Simple page button</a>
    <br>
    <br>
    <code><?php echo e($data); ?></code>
</div>
</body>
</html>
<?php /**PATH /var/www/html/views/index.blade.php ENDPATH**/ ?>